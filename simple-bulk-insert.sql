-- =====================================================
-- SSTH INVENTORY - SIMPLE BULK INSERT (FINAL FIX)
-- Addresses all NOT NULL constraints
-- =====================================================

-- =====================================================
-- PART 1: INSERT DEPARTMENTS (with dept_code)
-- =====================================================
...
-- =====================================================
-- PART 2: INSERT CATEGORIES (with category_code)
-- =====================================================
...
-- =====================================================
-- PART 3: INSERT ITEMS (using base_uom as string)
-- Note: Items table uses base_uom (string) not uom_id (FK)
-- =====================================================
...
SELECT
  ...
  END,
  uom, -- base_uom is a string, not a foreign key
  unit_cost,
  reorder_level,
  true,
  now(),
  'system' -- created_by default
FROM (VALUES
  -- WRITING INSTRUMENTS
...
SELECT category_code, category_name, COUNT(i.item_id) as item_count
FROM categories c
