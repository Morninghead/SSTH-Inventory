-- =====================================================
-- SSTH INVENTORY - MINIMAL INSERT
-- Only truncate tables that exist: items, categories, departments
-- =====================================================
...
BEGIN
    FOR t IN 
        ...
        AND table_name IN ('items', 'categories', 'departments')
    LOOP
...
-- =====================================================
-- STEP 2.5: ENSURE USER PROFILE EXISTS FOR SEEDING
-- =====================================================
...
FROM (VALUES
  ...
  ('OF-PP-001', 'A4 Paper (500 sheets)', 'Office', 'REAM', 150.00, 20),
  ('OF-PP-002', 'Copy Paper (500 sheets)', 'Office', 'REAM', 120.00, 30),
