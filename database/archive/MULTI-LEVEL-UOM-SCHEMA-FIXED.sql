...
DROP POLICY IF EXISTS "Everyone can view UOMs" ON uom;
CREATE POLICY "Everyone can view UOMs" ON uom
    FOR SELECT USING (true);

DROP POLICY IF EXISTS "Only admins can insert UOMs" ON uom;
...
DROP POLICY IF EXISTS "Only admins can update UOMs" ON uom;
...
DROP POLICY IF EXISTS "Everyone can view UOM conversions" ON uom_conversions;
CREATE POLICY "Everyone can view UOM conversions" ON uom_conversions
    FOR SELECT USING (true);

DROP POLICY IF EXISTS "Only admins can manage UOM conversions" ON uom_conversions;
