-- =====================================================
-- SSTH INVENTORY - CLEAN SLATE INSERT
-- Delete existing data and insert fresh
-- =====================================================

-- =====================================================
-- STEP 1: DELETE EXISTING DATA (in correct order to avoid FK violations)
-- =====================================================

-- Delete items first (has FK to categories)
DELETE FROM items;

-- Delete inventory_status (has FK to items)
DELETE FROM inventory_status;

-- Delete transaction_items (has FK to items)
DELETE FROM transaction_items;

-- Delete transactions
DELETE FROM transactions;

-- Delete purchase order items (has FK to items)
